...
function HeroArtwork() {
  return (
    <motion.div initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.75, ease: EASE, delay: 0.08 }} className="relative mx-auto h-[18rem] w-full max-w-[37rem] sm:h-[27rem] lg:h-[31rem]">
